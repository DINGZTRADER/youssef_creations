export const STORE = {
  ...
  city: 'Kampala, Uganda',
  logo: '/api/product-image?id=logo'
};
...
export const PRODUCTS = [
  ...
  {id:'stripe-zip-knit',name:'Striped Zip Knit',category:'Knitwear',price:null,image:driveImage('158SOYMVl6DmaZRDg8sWhNZNbzp9mESgKJ'),badge:'',desc:'Striped zip-neck knit tops for smart casual styling.'},
